import os
import numpy as np
from nets3.mrcnn import get_predict_model
from utils3.config import Config
from utils3.anchors import get_anchors
from utils3.utils import mold_inputs,unmold_detections
from utils3 import visualize
import keras.backend as K


class MASK_RCNN(object):
    _defaults = {
        "model_path": '../../../../data/mask-rcnn-keras-master/model_data/mask_rcnn_coco.h5',
        "classes_path": '../../../../data/mask-rcnn-keras-master/model_data/coco_classes.txt',
        "confidence": 0.7,
