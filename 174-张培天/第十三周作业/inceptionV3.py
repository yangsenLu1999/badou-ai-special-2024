...
def InceptionV3(input_shape=[229,229,3],classes=1000):
...
if __name__ == '__main__':
    model = InceptionV3()
    model.load_weights(r"E:\data\dabou\test\inception_v3_weights_tf_dim_ordering_tf_kernels.h5")
    img_path = r"E:\data\dabou\test\elephant.jpg"
