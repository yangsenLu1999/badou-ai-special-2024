...
class FRCNN(object):
    _defaults = {
        "model_path": r'E:\data\dabou\test\voc_weights.h5',
        "classes_path": r"E:\data\dabou\test\voc_classes.txt",
        "confidence": 0.7,
    }
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font=r'E:\data\dabou\test\simhei.ttf',size=np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
