...
class yolo_predictor:
    def __init__(self, obj_threshold, nums_threshold,classes_file,anchors_file):
    ...
    def _get_feats(self, feats, anchors, num_classes, input_shape):
        ...
        grid_y = tf.tile(tf.reshape(tf.range(grid_size[0]), [-1,1,1,1]), [grid_size[1], 1,1,1])
    ...
    def eval(self,yolo_outputs, image_shape, max_boxes=20):
        ...
        classes_ = tf.concat(classes, axis=0)
