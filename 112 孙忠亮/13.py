...
if __name__ == '__main__':
    ...
    model.load_weights("../../../../data/inceptionV3_tf/inception_v3_weights_tf_dim_ordering_tf_kernels.h5")

    img_path = '../../../../data/inceptionV3_tf/elephant.jpg'
    img = image.load_img(img_path, target_size=(299, 299))
    x = image.img_to_array(img)
    x = np.expand_dims(x, axis=0)
    x = preprocess_input(x)
    preds = model.predict(x)
    print('Predicted:', decode_predictions(preds, 2))
