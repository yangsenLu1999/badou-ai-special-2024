...
class BBoxUtility(object):
    def __init__(self, priors=None, overlap_threshold=0.7,ignore_threshold=0.3,
        ...
        self.overlap_threshold = overlap_threshold # 超过的为正样本
        self.ignore_threshold = ignore_threshold # 低的为负样本
    ...
    def iou(self, box):
        ...
        inter_wh = np.maximum(inter_wh, 0) # 交集区域的宽高
