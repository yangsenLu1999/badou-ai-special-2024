...
def inputs(data_dir, batch_size, distorted):
    ...
    if distorted != None:
        ...
        adjusted_brightness = tf.image.random_brightness(flipped_image, max_delta=0.6)
        adjusted_contrast = tf.image.random_contrast(adjusted_brightness, lower=0.2, upper=1.6)
