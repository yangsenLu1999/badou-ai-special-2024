...
class ShapesConfig(Config):
    NAME = "shapes"
    GPU_COUNT = 1
    IMAGES_PER_GPU = 1  # 每个GPU每次只处理一张图像
    BATCH_SIZE = 1  # 每次只送入一张图像
    NUM_CLASSES = 1 + 3  # 需要识别的类别数 1是背景数 3是形状数
    RPN_ANCHOR_SCALES = (16, 32, 64, 128, 256)  # 锚点大小
    # 输入图像到512*512
    IMAGE_MIN_DIM = 512
    IMAGE_MAX_DIM = 512

    STEPS_PER_EPOCH = 250  # 迭代步骤数250
    VALIDATION_STEPS = 25  # 验证数25
