...
from utils.config_homework import Config
import nets.frcnn_homework as frcnn
import colorsys
...
class FRCNN(object):
    ...
    def generate(self):
        ...
        assert model_path.endswith('.h5'), 'The model path must end with .h5'

        self.num_classes = len(self.class_names) + 1

        self.model_rpn, self.model_classifier = frcnn.get_perdict_model(self.config, self.num_classes)
