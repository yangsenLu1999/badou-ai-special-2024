...
data_dir = '../源码/Cifar/cifar_data/cifar-10-batches-bin'
...
def variable_with_weight_loss(shape, stddev, w1):
    ...
    if w1 is not None:
        wigths_logss = tf.multiply(tf.nn.l2_loss(var), w1, name="weights_loss")
        tf.add_to_collection("lossses", wigths_logss)
